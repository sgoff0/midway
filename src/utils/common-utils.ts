...
class CommonUtils {
   ...
   */
  public respondWithFile = async (route, h: Hapi.ResponseToolkit, options) => {
    // if (!this.urlCalls) {
    //   this.urlCalls = {};
    // }
    options = options || {};
...
//   respondWithFile: function (route, h: Hapi.ResponseToolkit, options) {
//     if (!this.urlCalls) {
//       this.urlCalls = {};
//     }
//     options = options || {};
...
//   readDirectory: async function (dirLocation) {
//     return await readDir(dirLocation);
//   },

//   readAndFilterDirectory: async (dirLocation, fileName) => {
//     try {
//       const files = await this.readDirectory(dirLocation);
//       const filteredFile = files.filter(function (file) {
//         Logger.debug('File to match: ' + file);
...
//   readFile: async function (fileLocation) {
//     return readFile(fileLocation, 'utf-8');
//   },
...
//   checkFileExists: async function (fileLocation) {
//     return exists(fileLocation);
//   },
...
//   resetMockVariantWithSession: async function (options) {
//     if (!options.hostName) {
//       // return callback(new Error('Missing hostName in options'));
//       throw new Error('Missing hostName in options');
//     }
...
//   setMockVariantWithSession: async function (options) {
//     if (!options.hostName) {
//       // e.g. localhost:8000, or www.someMidayOnPCF.com
//       // return callback(new Error('Missing hostName in options'));
//       throw new Error('Missing hostName in options');
...
//   // TODO sgoff0 finish refactoring
//   setMockVariant: async function (options, callback) {
